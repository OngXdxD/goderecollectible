                      ...
                      filteredAndSortedOrders.map(order => (
                        <React.Fragment key={order.id}>
                          <tr>
                            ...
                            <td>{formatCurrency(order.remaining_balance, order.currency)}</td>
                            <td>
                            ...
                            <td>
                              <div className="d-flex gap-2">
                                ...
                                <Button
                                  variant="info"
                                  size="sm"
                                  onClick={() => router.push(`/components/purchaseorder/${order.id}`)}
                                >
                                  Edit
                                </Button>
                                <Button
                                  ...
                                  <tbody>
                                    {order.items.map(item => (
                                      <tr key={item.id}>
                                        ...
                                        <td>{item.quantity}</td>
                                        <td>{formatCurrency(item.unit_cost, order.currency)}</td>
