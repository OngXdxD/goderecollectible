...
const SalesOrderTable = ({ productRows, updateRowQuantity, updateRowDeposit, updateRowPrice, totalAmount, totalDeposit, totalPaid, balance, currency }) => {
        ...
        <div>
            <Table striped bordered hover>
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colSpan="3" className="text-end"><strong>Total Deposit:</strong></td>
                        <td>{currency}</td>
